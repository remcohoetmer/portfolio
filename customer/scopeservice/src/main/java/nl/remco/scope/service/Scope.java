...
import static nl.remco.scope.util.PreCondition.isTrue;
import static nl.remco.scope.util.PreCondition.notEmpty;
import static nl.remco.scope.util.PreCondition.notNull;
